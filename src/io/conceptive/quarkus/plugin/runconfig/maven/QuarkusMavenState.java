...
class QuarkusMavenState extends JavaCommandLineState
{
  ...
  {
    OSProcessHandler result = new _ProcessHandler(QuarkusMavenState.this.createCommandLine());
   ...
   */
  private class _StartDebuggerListener extends ProcessAdapter
  {
   ...
   */
  private class _ProcessHandler extends ColoredProcessHandler
  {
